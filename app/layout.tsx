...
export const metadata: Metadata = {
  title: "AFFINITY '26 — Karpaga Vinayaga Institute of Medical Sciences & Research Centre",
  description:
    "AFFINITY '26 — 11th Edition, presented by the Dhruvaas batch. Theme: Arabian Nights.",
};
